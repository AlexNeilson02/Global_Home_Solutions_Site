...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-apple bg-card text-card-foreground shadow-apple-md border border-border transition-all duration-300 ease-apple hover:shadow-apple-lg hover:-translate-y-1",
      className
    )}
    {...props}
  />
