...
const HomeownerBottomNav: React.FC<HomeownerBottomNavProps> = ({
  ...
  return (
    <>
      ...
      <div className="block sm:hidden fixed bottom-0 left-0 right-0 z-50 pointer-events-auto">
            ...
            {tabs.map((tab) => {
              ...
              return (
                <button
                  ...
                  className={`flex flex-col items-center justify-center px-3 py-2 rounded-xl min-w-0 relative flex-1 transition-all duration-200 group min-h-[64px] touch-manipulation ${
                    isActive 
