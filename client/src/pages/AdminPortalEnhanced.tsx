    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="p-6">
        ...
        <Dialog open={viewDetailsOpen} onOpenChange={setViewDetailsOpen}>
          <DialogContent className="sm:max-w-[600px] shadow-2xl border-4 border-blue-400 bg-white ring-4 ring-blue-200 ring-opacity-50">
            <DialogHeader>
        ...
        <Dialog open={editModalOpen} onOpenChange={setEditModalOpen}>
          <DialogContent className="sm:max-w-[450px] max-w-[90vw] shadow-2xl border-4 border-blue-400 bg-white ring-4 ring-blue-200 ring-opacity-50">
            <DialogHeader>
        ...
        <Dialog open={contractorViewOpen} onOpenChange={setContractorViewOpen}>
          <DialogContent className="sm:max-w-[600px] max-w-[90vw] shadow-2xl border-4 border-blue-400 bg-white ring-4 ring-blue-200 ring-opacity-50">
            <DialogHeader
        ...
        <Dialog open={contractorEditOpen} onOpenChange={setContractorEditOpen}>
          <DialogContent className="sm:max-w-[500px] max-w-[90vw] shadow-2xl border-4 border-blue-400 bg-white ring-4 ring-blue-200 ring-opacity-50">
            <DialogHeader
              className="anti-yellow-nuclear"
              style={{
                outline: 'none',
