    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="p-6">
        ...
        <Dialog open={viewDetailsOpen} onOpenChange={setViewDetailsOpen}>
          <DialogContent className="sm:max-w-[600px] shadow-xl border-2 border-blue-300 bg-white">
            <DialogHeader>
        ...
        <Dialog open={editModalOpen} onOpenChange={setEditModalOpen}>
          <DialogContent className="sm:max-w-[450px] max-w-[90vw] shadow-xl border-2 border-blue-300 bg-white">
            <DialogHeader>
        ...
        <Dialog open={contractorViewOpen} onOpenChange={setContractorViewOpen}>
          <DialogContent className="sm:max-w-[600px] max-w-[90vw] shadow-xl border-2 border-blue-300 bg-white">
            <DialogHeader
        ...
        <Dialog open={contractorEditOpen} onOpenChange={setContractorEditOpen}>
          <DialogContent className="sm:max-w-[500px] max-w-[90vw] shadow-xl border-2 border-blue-300 bg-white">
            <DialogHeader
              className="anti-yellow-nuclear"
              style={{
                outline: 'none',
